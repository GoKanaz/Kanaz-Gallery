...
class SettingsFragment : Fragment() {
    ...
    private fun setupSettingsList() {
        val settingsItems = listOf(
            SettingsItem(title = "Theme", summary = "Change app theme", type = SettingsType.THEME),
            SettingsItem(title = "Sort by", summary = "Date, Name, or Size", type = SettingsType.SORT),
            SettingsItem(title = "Sort order", summary = "Ascending or Descending", type = SettingsType.ORDER),
            SettingsItem(title = "About", summary = "Kanaz Gallery v1.0", type = SettingsType.ABOUT)
        )
