...
class VideoPlayerActivity : AppCompatActivity() {
    ...
    private fun playVideo() {
        val uri = intent.getParcelableExtra<Uri>(Constants.EXTRA_MEDIA_ID) ?: return
    ...
    private fun toggleControls() {
        binding.videoControls.visibility = if (binding.videoControls.visibility == View.VISIBLE) {
            View.GONE
        } else {
            View.VISIBLE
        }
